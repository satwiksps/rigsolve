...
import { documentationUrl, repositoryUrl } from "../site-config";
...
export function MobileMenu() {
  ...
  return (
    <div className="relative md:hidden" ref={menuRef}>
      ...
      {open ? (
        <div
          className="absolute top-12 right-0 w-56 overflow-hidden rounded-lg border border-white/10 bg-[#111114] p-1.5 shadow-2xl shadow-black/50"
